...
- Discovery (later corrected 2026-06-02): thought `build-a-thon.dsrs.illinois.edu` was an nginx mirror stuck at a May 8 snapshot needing a manual DSRS refresh. **Actually wrong** — see the 2026-06-02 entry: the mirror auto-syncs fine; it just only shipped the root page.
